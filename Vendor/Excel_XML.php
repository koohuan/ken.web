 ...
 * @link http://code.google.com/p/php-excel/wiki/QuickUsageGuide
...
class Excel_XML
{
	 ...
	 */
	     ...
	     * save xml to file
	     * 
	     * @link https://github.com/mincms/mincms
	     * @auth Sun Kang
	     * @param full path contain filename $filename
	     */
	    function save ($filename){  
            $out = stripslashes (sprintf($this->header, $this->sEncoding));
