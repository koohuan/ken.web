...
$menu = [
    ...
    'arr'=>"数组",
    'tree'=>"树Tree",
    'vendor'=>"清除Composer生成的vendor中无用文件及目录",
];
$file = $dir.$i.'.md';
...
<div class="navbar navbar-inverse">
  ...
  <div class="navbar-header">
    ...
    <a class="navbar-brand" href="#">Ken.Web框架开发手册</a>
  </div>
  <div class="navbar-collapse collapse navbar-inverse-collapse">
    <ul class="nav navbar-nav">
      <li><a href="https://github.com/nonetaichi/ken.web" target='_blank'>GIT代码库</a></li>
...
<div class="container">	
	<div class="row">
     ...
     <div class="blog-footer">
      <p>Ken.Web PHP5.4+ 开发框架 GIT <a href="https://github.com/nonetaichi/ken.web" target='_blank'>Ken.Web</a> by <a href="mailto:68103403@qq.com">@Sun Kang</a>.</p>
      <p>
        <a href="#top">返回顶部</a>
      </p>
    </div>
